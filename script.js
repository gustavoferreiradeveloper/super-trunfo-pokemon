...
function jogar() {
  ...
  if (valorCartaJogador > valorCartaMaquina) {
    htmlResultado = "<p class='resultado-final vencedor'>Você venceu!</p>";
  } else if (valorCartaJogador < valorCartaMaquina) {
    htmlResultado = "<p class='resultado-final perdedor'>Você perdeu!</p>";
  } else {
    htmlResultado = "<p class='resultado-final empate'>Empataram!</p>";
  }
